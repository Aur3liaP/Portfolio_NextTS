...
export default function ContactForm() {
  ...
  return (
    <div className="relative">
      ...
      >
        <div className="relative">
          <label htmlFor="name" className="absolute -top-2 left-4 bg-background px-2 text-sm">
            Nom
          </label>
          <input
            type="text"
        ...
        <div className="relative">
          <label htmlFor="email" className="absolute -top-2 left-4 bg-background px-2 text-sm">
            Mail
          </label>
          <input
            type="email"
        ...
        <div className="relative">
          <label htmlFor="message" className="absolute -top-2 left-4 bg-background px-2 text-sm">
            Message
          </label>
          <textarea
            id="message"
